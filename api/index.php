...
<body>
    ...
    <script>
        const customCalendarColors = {
            "กสข.": "#db2777",  // สีชมพูเข้ม
            "ฝบป.": "#2563eb",  // สีน้ำเงินหลัก
            "ฝปบ.": "#2563eb",  // ดักเผื่อพิมพ์สลับ
            "ฝวบ.": "#9333ea",  // 🌟 สีม่วงเข้ม (สไตล์ Smart Dashboard)
            "ฝสบ.": "#f97316",  // สีส้มสว่าง
            "คอมพิวเตอร์และเครือข่าย": "#16a34a" // สีเขียว
        };
